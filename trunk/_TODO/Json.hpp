...
namespace XTL
{
	...
	class JsonValue
	{
		public:
			...
			const char * TypeName() const  { return TypeNames[TypeId()]; }
	...
	class JsonIntegerValue : public JsonValue
	{
		public:
			...
			virtual int TypeId() const  { return JSON_INTEGER; }
	...
	class JsonFloatValue : public JsonValue
	{
		public:
			...
			virtual int TypeId() const  { return JSON_FLOAT; }
	...
	class JsonStringValue : public JsonValue
	{
		public:
			...
			virtual int TypeId() const  { return JSON_STRING; }
	...
	class JsonBooleanValue : public JsonValue
	{
		public:
			...
			virtual int TypeId() const  { return JSON_BOOLEAN; }
	...
	class JsonArrayValue : public JsonValue
	{
		...
		public:
			...
			virtual int TypeId() const  { return JSON_ARRAY; }
	...
	class JsonObjectValue : public JsonValue
	{
		...
		public:
			...
			virtual int TypeId() const  { return JSON_OBJECT; }
...
/*
	class JsonConstant
	{
		public:
			...
			int TypeId() const
			{
				return value_ == 0 ? JSON_UNDEFINED : value_->TypeId();
			}
			...
			bool IsNull()    const  { return TypeId() == JSON_NULL; }
			bool IsInteger() const  { return TypeId() == JSON_INTEGER; }
			bool IsFloat()   const  { return TypeId() == JSON_FLOAT; }
			bool IsString()  const  { return TypeId() == JSON_STRING; }
			bool IsBoolean() const  { return TypeId() == JSON_BOOLEAN; }
			bool IsArray()   const  { return TypeId() == JSON_ARRAY; }
			bool IsObject()  const  { return TypeId() == JSON_OBJECT; }
...
*/
	...
	class JsonVariableBase
	{
		public:
			...
			int TypeId() const
			{
				return value_ == 0 ? JSON_NULL : value_->TypeId();
			}
